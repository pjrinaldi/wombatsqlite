...
public:
    ...
    void setupUi(QDialog *AboutBox)
    {
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 418, 446));
        scrollAreaWidgetContents->setMinimumSize(QSize(403, 0));
        ...
        piclabel->setMinimumSize(QSize(401, 0));
        piclabel->setTextFormat(Qt::PlainText);
        piclabel->setPixmap(QPixmap(QString::fromUtf8(":/aboutwombat")));
        ...
        textlabel->setMinimumSize(QSize(401, 0));
