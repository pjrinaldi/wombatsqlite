...
{
    ui->setupUi(this);
    QString abouttext = "<h3>About Wombat SQLite v0.1</h3>";
    ...
    abouttext += "<p>Wombat SQLite parses a SQLite file (database, WAL, JOURNAL) to manually parse the files from a forensic perspective rather than a simple database browser.</p>";
